...
import { Camera, RefreshCw, SendHorizontal, MessageSquare, MapPin, Users, Edit3, Trash2, Upload, Download, Maximize2, Wand2, Plus, X, Link } from 'lucide-react';
...
export const ShotCard: React.FC<ShotCardProps> = ({ 
  ...
  const handleDownload = () => {
    ...
    link.download = `shot-${shot.number}.png`;
